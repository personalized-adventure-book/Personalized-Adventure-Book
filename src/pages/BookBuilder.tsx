...
// Using global tracking system from @/utils/tracking
...
const BookBuilder = () => {
  ...
  // Using global tracking system - no local event listeners needed
                          ...
                          <CardContent className="space-y-6">
                            <div>
                              ...
                              {!experience.title && hasAttemptedProceed && (
                                <p className="text-xs text-red-500 mt-1">
                                  {t("validation.experienceNameRequired")}
                                </p>
                              )}
                            </div>
                            ...
                            <div>
                              ...
                              <Input
                                ...
                                placeholder={t("placeholder.characters")}
                                className="mt-1"
                              />
                            </div>
